...
|--------------|------------------|------------------|-------------|
| `Spec-Ref`   | free text        | (none)           | OCPP specification section reference (e.g. `OCPP 2.0.1 §B01 BootNotification`). Required for conformance stories; forbidden for helper stories. |
